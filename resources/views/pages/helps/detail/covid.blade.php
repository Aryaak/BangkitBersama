        ...
        <div class="card-text">
            <table class="table table-column">
                ...
                <tr class="tinggi">
                    ...
                    <td class="col-md-6 ">
                        @if ($data_covid->help_status_id == 1)
                        <span class="badge badge-pill badge-warning">pending</span>
                        @endif
                        @if ($data_covid->help_status_id == 2)
                        <span class="badge badge-pill badge-success">accepted</span>
                        @endif
                        @if ($data_covid->help_status_id == 3)
                        <span class="badge badge-pill badge-danger">rejected</span>
                        @endif
                        @if ($data_covid->help_status_id == 4)
                ...
                <tr class="tinggi">
                    ...
                    <td>{{$data_covid->rejected_reason}}</td>
                </tr>
                @endif
                <tr class="tinggi">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="d-flex">
                                                            <form action="/covid/{{ $help->id }}/delete"
                                                                method="post">
                                                                @csrf
                                                                @method("DELETE")
